...
public class MySQLUserRepositoryImpl implements UserRepository {
    ...
    public boolean addUser(User user) {
        try{
            PreparedStatement preparedStatement = masterConnection.prepareStatement(INSERT_USER_DML_SQL);
    ...
    public User getUserByName(String name) {
        try{
            PreparedStatement preparedStatement = slaveConnection.prepareStatement(QUERY_USER_BY_NAME_SQL);
